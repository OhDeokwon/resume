	...
	activities: [
		{
			...
			date: '2018.11',
			description: 'KB 금융지주에서 SOPT 회원들을 대상으로 2주 동안 진행된 해커 톤입니다. OpenCV와 Project Oxford를 활용해 영수증 인식기능을 구현했습니다. 간단하게나마 앱 내에서 영상처리 기술을 시도해본 좋은 경험이었던 것 같습니다.'
		},
		{
		...
		},
		{
			...
			date: '2018.11',
			description: '소프트웨어 마에스트로 8기를 수료했습니다. DX, DXUT를 활용해 컴포넌트 게임엔진을 제작했습니다. 디자인 패턴과 코드로 작성한 것들이 어떻게 화면에 그려지는지에 대해 알 수 있는 뜻깊은 프로젝트였습니다.'
		},
		{
		...
		},
		{
			...
			description: '인디 게임 카페에서 팀을 모아 제작한 게임입니다. 간단한 게임이었지만, 원격에서 작업하는 것과 모르는 사람들이 모여서 개발한다는 점에서 많은 어려움을 겪었습니다. 현재는 정책 위반으로 잠시 내려놓은 상태이며 약 1달 만에 구글 플레이스토어 5,000명 다운로드, 아케이드 게임 순위 TOP10에 진입했었습니다. 프로젝트의 완료가 얼마나 힘든 것인지 몸소 깨닫게 해준 정말 감사한 프로젝트였습니다.'
		}
	]
}
